...
// connect to the database
 ...
 $aval = $_POST['aval'];
 $query = "UPDATE delivery SET availabillity = '$aval'  WHERE username = '$username'";
...
<body class="bg-img3">
  <div class="row">
      ...
      <input type="submit" value="Έναρξη/Λήξη βάρδιας"/>
              ...
              <tr>    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"><input type="submit" name='aval' value="Active"></form>
                  <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>"><input type="submit" name='aval' value="Inactive"></form>
 </tr> </table>
  </div>
</div>
</div>
